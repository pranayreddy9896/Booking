  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
            ...
            <p className='text-xs font-inter py.1.5 px-3 text-while bg-orange-500 rounded-full'> 20% Off</p>
        </div>
        {/* room rating */}
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length>1 && room.images.map((image,index)=>(
                    <img onClick={()=> SetMainImage(image)} 
                     ...
                     shadow-md object-cover cursor-pointer 
        ...
        text-white rounded-md max-md:w-full max-md:mt-6 md:px-10 py-3 md:py-4 text-base cursor-pointer'> 
            Check Availability
        </button>
        </form>
        ...
        <div className=' max-w-3xl border-y borer-gray-300 my-15 py-10 text-gray-500'>
...
You get a comfortable Two bedroom apartment has a true city feeling, The
 ...
 floor according to availability. You get the comfortable
 two bedroom apartment that has a true city feeling.</p>
        </div>
        {/** hosted by */}
        <div className='fledx flex-col items-start gap-4'>
